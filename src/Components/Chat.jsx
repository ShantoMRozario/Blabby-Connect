...
const Chat = () => {
    ...
    return (
        <div>
                {
                    selectedFriend?.status == 'selected' ?
                    <>
                    <div className="">
                    ...
                    <div className="overflow-y-scroll h-[710px] px-[20px] pt-2  mb-[500px]">
                        {
                            messageList.map((item)=>{
                                return(
                                    item.sentById == data.uid ?
                                    <div className="senttextMain">
                                        <div className="senttext flex gap-4 mb-5 justify-end ">
                                            <h5 className="text-sm text-textAshColor">{item.date}</h5>
                                            <p className="bg-primaryColor text-whiteColor w-[80%] p-5 text-justify rounded-lg rounded-tr-none">{item.message}</p>
                                            <div className="image bg-textOrangeColor w-[50px] h-[50px] rounded-full overflow-hidden border-2 border-primaryColor">
                                                <span className="font-bold flex justify-center items-center  mt-2">G</span>
                                            </div>
                                    ...
                                    <div className="receivetextMain">
                                        <div className="receivetext flex gap-4 mb-5">
                                            ...
                                            <p className="bg-textLightAshColor w-[80%] p-5 text-justify rounded-lg rounded-tl-none">{item.message}</p>
                                            <h5 className="text-sm text-textAshColor">{item.date}</h5>
                                        </div>
                                    </div>
                                )
        ...
        {/* 
                    ...
                    :
                    <h2 className="flex justify-center items-center">Tab Friends to View Message</h2>
                }
        </div>
    );
};
